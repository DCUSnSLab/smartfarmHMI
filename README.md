...
9. [docs/03-architecture/tech-stack.md](./docs/03-architecture/tech-stack.md) — 기술 스택 (AIBootcamp 정합)
10. [docs/04-roadmap/phase2-scope.md](./docs/04-roadmap/phase2-scope.md) — 2차년도 로드맵과 현재 개발 범위
11. [docs/design/README.md](./docs/design/README.md) — 디자인 전달본 (화면 구조·디자인 토큰)
12. [docs/design/design-change-spec.md](./docs/design/design-change-spec.md) — 디자인 변경 명세 (요구사항 정합화에 따른 후속 작업)
